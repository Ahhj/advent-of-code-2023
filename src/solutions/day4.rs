...
pub fn print_solutions_day4() {
    let example_input_raw: &str = &dedent(
        "
    ...
    // Example part 1
    let example_expected_part1: u32 = 13;
    let example_solution_part1: u32 = get_solution_day4_part1(&example_input_raw);
    assert_eq!(example_expected_part1, example_solution_part1);

    // Example part 2
    let example_expected_part2: u32 = 30;
    let example_solution_part2: u32 = get_solution_day4_part2(&example_input_raw);
    assert_eq!(example_expected_part2, example_solution_part2);

    // Part 1
    let input_data_raw = get_input_for_day(4);
    let solution_part1 = get_solution_day4_part1(&input_data_raw);
    println!("Day 4, part 1: {solution_part1}");

    // Part 2
    let solution_part2 = get_solution_day4_part2(&input_data_raw);
    println!("Day 4, part 2: {solution_part2}");
}
